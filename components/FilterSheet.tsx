    ...
    return (
        <>
            ...
            <button
                ...
                className="fixed bottom-6 right-6 z-40 bg-gray-900 text-amber-400 hover:bg-amber-400 hover:text-gray-900 font-semibold py-3.5 px-7 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 flex items-center gap-2.5"
            >
