                        ...
                        {menuOpen && (
                            <div className="absolute right-0 top-full mt-2 w-64 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl shadow-2xl overflow-hidden animate-fade-in z-50">
                                ...
                                <nav className="py-2">
                                    ...
                                    <MenuLink href="/pricing/owners" icon="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z" onClick={() => setMenuOpen(false)}>
                                        Pricing — For Owners
                                    </MenuLink>
                                    <MenuLink href="/pricing/tenants" icon="M15 7a2 2 0 012 2m4 0a6 6 0 01-7.743 5.743L11 17H9v2H7v2H4a1 1 0 01-1-1v-2.586a1 1 0 01.293-.707l5.964-5.964A6 6 0 1121 9z" onClick={() => setMenuOpen(false)}>
                                        Pricing — For Tenants
                                    </MenuLink>
